describe('Unit: Testing Services', function() {
	describe('Panel Item Service:', function() {
		...
		it('should create and modify an item', function(){
			var newItem = {active: true, description: "temporary", price: 3, title: "New Item"}
			...
			var i = ItemService.save(newItem);
			$httpBackend.flush();

			expect(i.numberOrdered).toEqual(0);
			expect(i.description).toEqual('temporary');
